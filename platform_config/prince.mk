...
SUITESPARSE_LFLAGS=-L$(SUITESPARSE_LIB) -lcholmod -lumfpack \
	-L$(SUITESPARSE_LIB) -lmetis \
...
CERES_LFLAGS=-L$(CERES_LIB) -lceres -lglog -lgflags -lpthread
LIBMATHEVAL_LFLAGS=-L$(LIBMATHEVAL_LIB) -lmatheval -L$(FLEX_LIB) -lfl
