...
CLIPPER_INC=/usr/local/include/polyclipping
LEVMAR_INC=$(HOME)/Research/libraries/levmar-2.6/
LEVMAR_LIB=$(HOME)/Research/libraries/levmar-2.6/build
...
INCLUDES=-I$(CSGFEM_INC) -I$(EIGEN_INC) -I$(SUITESPARSE_INC) -I$(BOOST_INC) \
		 -I$(CERES_INC) -I$(LIBMATHEVAL_INC) -I$(CLIPPER_INC)
