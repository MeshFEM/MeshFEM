...
if(NOT TARGET tbb::tbb)
    ...
    set(TBB_COMPILE_FLAGS "-Wno-implicit-fallthrough -Wno-missing-field-initializers -Wno-unused-parameter -Wno-keyword-macro")
    if (MESHFEM_USE_PIC)
        set(TBB_COMPILE_FLAGS "${TBB_COMPILE_FLAGS} -fPIC")
    endif()
    set_target_properties(tbb_static PROPERTIES COMPILE_FLAGS "${TBB_COMPILE_FLAGS}")
