...
if(CHOLMOD_FOUND AND NOT TARGET cholmod::cholmod)
  if(${CMAKE_VERSION} VERSION_LESS "3.11.0")
    add_library(cholmod_cholmod INTERFACE)
    target_include_directories(cholmod_cholmod SYSTEM INTERFACE ${CHOLMOD_INCLUDES})
    target_link_libraries(cholmod_cholmod INTERFACE "${CHOLMOD_LIBRARIES}")
    add_library(cholmod::cholmod ALIAS cholmod_cholmod)
  else()
    add_library(cholmod::cholmod INTERFACE IMPORTED)
    target_include_directories(cholmod::cholmod SYSTEM INTERFACE ${CHOLMOD_INCLUDES})
    target_link_libraries(cholmod::cholmod INTERFACE "${CHOLMOD_LIBRARIES}")
  endif()
endif()
