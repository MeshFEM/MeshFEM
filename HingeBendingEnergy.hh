...
struct HingeBendingEnergy {
    ...
    HingeBendingEnergy(HingeBendingEnergy<_Real2> h2) : e_bar_len(h2.e_bar_len), h_bar(h2.h_bar), theta_bar(h2.theta_bar) {
    ...
    HingeBendingEnergy(Eigen::Ref<const Pt> ref_p0,
    ...
    HessType hessTheta() const {
        ...
        HingeBendingEnergy<ADType> diff_he(*this);
