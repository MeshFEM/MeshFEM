...
def generate_R_script(csv_file, prefix, rank, err_bound):
    ...
    with open(r_file, 'w') as fout:
        ...
        r_template.get_def("save_plot").render_context(Context(
            ...
            out_name = "{}_lambda_mu.pdf".format(prefix)));
        ...
        r_template.get_def("save_plot").render_context(Context(
            fout, width=10, height=6,
            out_name = "{}_young_poisson.pdf".format(prefix)));
        ...
        for p in range(rank):
            ...
            r_template.get_def("save_plot").render_context(Context(
                ...
                out_name = "{}_lambda_mu.pdf".format(extended_prefix)));
            ...
            r_template.get_def("save_plot").render_context(Context(
                fout, width=20, height=12,
                out_name = "{}_young_poisson.pdf".format(extended_prefix)));
