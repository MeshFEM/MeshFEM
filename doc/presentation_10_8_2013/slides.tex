...
\begin{frame}{Building the System: The Stiffness Matrix}
    ...
    \begin{itemize}
        \item The stiffness matrix integral can be broken down into per-element integrals:
            \begin{align*}
...
\begin{frame}{The Stiffness Matrix: Cut Cells}
    \begin{itemize}
        \item The difficulty comes in at the ``cut'' cells:
            ...
            \end{figure}
        \item Here we compute the integral
            $$
...
\begin{frame}{Structural Optimization}
 ...
 \pause \item Representative approach for topology optimization:
    ...
    \begin{figure}
        ...
        \source{Wikipedia}
    \end{figure}
    \item But, we can use our CSG representation to combine sizing/shape/topology optimization
    \end{itemize}
\end{frame}
...
\begin{frame}{Problems: Discontinuity}
    \begin{itemize}
        ...
        \end{figure}
        (simulation geometry only changes when different quadrature points are covered)
    \end{itemize}
\end{frame}
...
\begin{frame}{Problems: Infinite Stress}
    \begin{itemize}
     ...
     \end{figure}
    \item As the grid refines around these areas, stress diverges.
    \item Small changes in how corners overlap the grid can vary cell stress
          averages dramatically $\Rightarrow$ amplifies discontinuity in W.
    \item Note: boundary-conforming (e.g. tet) meshes don't have this problem
...
\begin{frame}{Re-entrant Corner}
        \begin{figure}
            ...
            \raisebox{.05\textwidth}{\includegraphics[width=.26\textwidth]{StressRefinement/pie_180/frame_1.png}} \quad
...
\begin{frame}{Re-entrant Corner}
        \begin{figure}
            ...
            \raisebox{.05\textwidth}{\includegraphics[width=.26\textwidth]{StressRefinement/pie_180/frame_2.png}} \quad
...
\begin{frame}{Re-entrant Corner}
        \begin{figure}
            ...
            \raisebox{.05\textwidth}{\includegraphics[width=.26\textwidth]{StressRefinement/pie_180/frame_3.png}} \quad
...
\begin{frame}{Re-entrant Corner}
        \begin{figure}
            ...
            \raisebox{.05\textwidth}{\includegraphics[width=.26\textwidth]{StressRefinement/pie_180/frame_4.png}} \quad
...
\begin{frame}{Re-entrant Corner}
        \begin{figure}
            ...
            \raisebox{.05\textwidth}{\includegraphics[width=.26\textwidth]{StressRefinement/pie_180/frame_5.png}} \quad
...
\begin{frame}{Re-entrant Corner}
        \begin{figure}
            ...
            \raisebox{.05\textwidth}{\includegraphics[width=.26\textwidth]{StressRefinement/pie_180/frame_6.png}} \quad
...
\begin{frame}{Re-entrant Corner}
        \begin{figure}
            ...
            \raisebox{.05\textwidth}{\includegraphics[width=.26\textwidth]{StressRefinement/pie_180/frame_7.png}} \quad
