...
PYBIND11_MODULE(sparse_matrices, m) {
    ...
    py::enum_<CholeskyProvider>(m, "CholeskyProvider")
        ...
        .value("CatamariScotch",   CholeskyProvider::CatamariScotch)
#endif
    ...
    py::enum_<CFB::FactorizationType>(pyCFB, "FactorizationType")
        ...
        .value("Symbolic", CFB::FactorizationType::Symbolic)
        .value("Numeric",  CFB::FactorizationType::Numeric)
        ;
    ...
    pyCFB
        ...
        .def("factorizeSymbolic", [](CFB &c, const SuiteSparseMatrix &mat, const std::vector<size_t> &pinnedVars) { c.factorizeSymbolic(mat, pinnedVars); }, py::arg("mat"), py::arg("pinnedVars") = std::vector<size_t>())
        .def("factorizeSymbolic", [](CFB &c, const BlockCSCHessianBase &mat, const std::vector<size_t> &pinnedVars) { c.factorizeSymbolic(mat, pinnedVars); }, py::arg("mat"), py::arg("pinnedVars") = std::vector<size_t>())
        ...
        .def("factorizeNumeric", [](CFB &c, const BlockCSCHessianBase &mat, bool isInTryCatch) { c.factorizeNumeric(mat, isInTryCatch); }, py::arg("mat"), py::arg("isInTryCatch") = false)
