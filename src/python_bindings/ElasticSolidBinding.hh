#ifndef ELASTICSOLIDBINDING_HH
#define ELASTICSOLIDBINDING_HH
...
template<template<typename, size_t> class Energy>
void generateElasticSolidBindingsForEnergy(py::module &m, py::module &detail_module) {
