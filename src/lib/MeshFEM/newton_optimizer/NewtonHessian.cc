...
BorderedSparseFactorization::BorderedSparseFactorization(const NewtonHessian &H, const std::vector<size_t> &fixedVars,
...
bool BorderedSparseFactorization::m_updateDenseFactorization(const NewtonHessian &H) {
    H.validate();
