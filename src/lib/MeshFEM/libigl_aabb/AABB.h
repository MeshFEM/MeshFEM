...
#ifndef IGLAABB_AABB_H
#define IGLAABB_AABB_H
...
public:
    ...
    {}
      ...
      IGLAABB_INLINE bool is_leaf() const;
      ...
      IGLAABB_INLINE std::vector<int> find(
          const Eigen::MatrixBase<DerivedV> & V,
          const Eigen::MatrixBase<DerivedEle> & Ele, 
      ...
      IGLAABB_INLINE int subtree_size() const;
      ...
      // dimension.
      template <typename DerivedEle>
      IGLAABB_INLINE Scalar squared_distance(
        const Eigen::MatrixBase<DerivedV> & V,
        const Eigen::MatrixBase<DerivedEle> & Ele, 
...
//private:
      ...
      // All hits
      template <typename DerivedEle>
      IGLAABB_INLINE bool intersect_ray(
        const Eigen::MatrixBase<DerivedV> & V,
        const Eigen::MatrixBase<DerivedEle> & Ele, 
...
public:
      ...
      template <
        ...
        typename DerivedI, 
        typename DerivedC>
      IGLAABB_INLINE void squared_distance(
        const Eigen::MatrixBase<DerivedV> & V,
        const Eigen::MatrixBase<DerivedEle> & Ele, 
...
private:
      template < 
        ...
        typename DerivedI, 
        typename DerivedC>
      IGLAABB_INLINE Scalar squared_distance_helper(
        const Eigen::MatrixBase<DerivedV> & V,
        const Eigen::MatrixBase<DerivedEle> & Ele, 
        const AABB<Derivedother_V,DIM> * other,
        const Eigen::MatrixBase<Derivedother_V> & other_V,
      ...
      template <typename DerivedEle>
      IGLAABB_INLINE void leaf_squared_distance(
        const Eigen::MatrixBase<DerivedV> & V,
        const Eigen::MatrixBase<DerivedEle> & Ele, 
        const RowVectorDIMS & p,
        const Scalar low_sqr_d,
