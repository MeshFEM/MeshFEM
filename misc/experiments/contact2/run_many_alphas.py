...
for alpha in alpha_values:
    ...
    cmd = ['../../../cmake-build-release/MeshFEM/SimulateWithContact_cli', 'contact_hook.msh', '-o', "out_alpha_{:.2e}.msh".format(alpha), '-m', '../../../../../microstructures-github/materials/B9Creator.material',
