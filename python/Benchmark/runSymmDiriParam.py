...
def recordStatistics(base_path, model_name, model_path, hessian_proj_option, thread_num, repeat_num, hessian_shift):
    ...
    for i in range(repeat_num):
        ...
        elif hessian_proj_option in ['MeshFEM_TAD_Fad', 'MeshFEM_TAD_Xad', 'MeshFEM_CM', 'MeshFEM_CM_adp', 'MeshFEM_CM_adp_xbased']:
...
def main():
    ...
    if (hessian_proj_option not in ['TinyAD', 'CompMajor', 'SLIM', 'MeshFEM_TAD_Fad', 'MeshFEM_TAD_Xad', 'MeshFEM_CM', 'MeshFEM_CM_adp', 'MeshFEM_CM_adp_xbased']) and (not SolverOptionEnum.is_valid_solver_option(hessian_proj_option)):
        print("[Error] Usage of <hessian_proj_option>:  ['TinyAD', 'CompMajor', 'SLIM', 'MeshFEM0'~'MeshFEM31', 'MeshFEM_TAD_Fad', 'MeshFEM_TAD_Xad', 'MeshFEM_CM', 'MeshFEM_CM_adp', 'MeshFEM_CM_adp_xbased']")
        sys.exit(1)
